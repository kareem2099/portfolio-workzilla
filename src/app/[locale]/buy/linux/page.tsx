...
export default function LinuxBuyPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 dark:bg-gradient-to-br dark:from-slate-900 dark:via-purple-950 dark:to-slate-900 dark:text-slate-100 py-16 px-4 sm:px-6 lg:px-8">
      <motion.div
        ...
        animate={{ opacity: 1 }}
      >
        <h1 className="text-5xl font-bold mb-4">Stocktune for Linux</h1>
        <Image
        ...
        <p className="mb-4">Thank you for purchasing Stocktune for Linux! To complete your purchase, please click the button below:</p>
        <button className="bg-sky-500 hover:bg-sky-700 text-white font-bold py-2 px-4 rounded" onClick={() => setShowPayment(true)}>
          Buy Now - $30 (Linux Version)
        </button>
        {showPayment && (
