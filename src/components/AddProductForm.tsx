...
export default function AddProductForm() {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 shadow-md rounded p-4 transition-colors duration-500 hover:scale-105">
      <h2 className="text-xl font-bold mb-2 text-gray-800 dark:text-gray-200 transition-colors duration-500">Add Product</h2>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input type="text" id="windowsBuyLink" name="windowsBuyLink" value={product.windowsBuyLink} onChange={handleChange} required className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 dark:text-gray-300 leading-tight focus:outline-none focus:shadow-outline transition-colors duration-500 dark:bg-gray-700 focus:ring-2 focus:ring-blue-500" />
        </div>
        <div>
          ...
          <input type="text" id="linuxBuyLink" name="linuxBuyLink" value={product.linuxBuyLink} onChange={handleChange} required className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 dark:text-gray-300 leading-tight focus:outline-none focus:shadow-outline transition-colors duration-500 dark:bg-gray-700 focus:ring-2 focus:ring-blue-500" />
        </div>
        <button type="submit" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline transition-colors duration-500 hover:scale-105">Add Product</button>
      </form>
    </div>
  );
}
